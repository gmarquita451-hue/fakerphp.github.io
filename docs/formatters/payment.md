...
// ['type' => 'Visa', 'number' => '4961616159985979', 'name' => '  marquita green', 'expirationDate' => '01/31']

echo $faker->creditCardDetails(false);

// ['type' => 'MasterCard', 'number' => '2720381993865020', 'name' => 'marquita green', 'expirationDate' => '10/31']
```
